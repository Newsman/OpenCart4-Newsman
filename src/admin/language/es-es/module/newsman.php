...
$_['text_header_edit'] = 'Configuración';
$_['text_header_developer_edit'] = 'Configuración de desarrollador';
$_['text_close'] = 'Cerrar';
...
$_['text_credentials_invalid'] = '¡Las credenciales son inválidas o hay un error temporal de API!';
...
$_['text_export_authorize_header_name_help'] = $_['text_export_authorize_header_key_help'] = 'Por favor, utilice solo caracteres alfanuméricos y el carácter guión.';
$_['text_api_status_hint'] = 'El ID y la clave API utilizados son válidos. La conexión a la API de NewsMAN fue probada y está funcionando.';
$_['text_remarketing_settings'] = 'Configuración de remarketing';
...
$_['entry_developer_api_timeout'] = 'Tiempo de espera de API';
$_['entry_developer_active_user_ip'] = 'Activar IP de prueba';
$_['entry_developer_user_ip'] = 'IP de prueba';
$_['entry_export_subscribers_by_store'] = 'Exportar suscriptores por tienda';
$_['entry_export_subscribers_by_store_help'] = 'Active esto si desea exportar solo los suscriptores pertenecientes a esta tienda.';
...
$_['entry_server_ip_help'] = 'La dirección IP del servidor se enviará a la API de NewsMAN en lugar de la dirección IP del usuario. Se utiliza cuando "Enviar dirección IP del usuario" está configurado como "Desactivado".';
$_['entry_developer_active_user_ip_help'] = 'Enviar siempre la dirección IP de prueba a la API de NewsMAN. Esta opción no debe estar activada en entorno de producción.';

// Error
$_['error_permission'] = '¡No tiene permiso para modificar el módulo NewsMAN!';
$_['error_step3_save'] = 'Se produjo un error al guardar las credenciales de NewsMAN en la administración. Por favor, inténtelo de nuevo.';
$_['error_access_denied'] = 'El acceso está denegado.';
