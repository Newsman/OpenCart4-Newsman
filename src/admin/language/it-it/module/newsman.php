...
$_['text_credentials_invalid'] = 'Le credenziali non sono valide o si è verificato un errore API temporaneo!';
...
$_['text_export_authorize_header_name_help'] = $_['text_export_authorize_header_key_help'] = 'Utilizzare solo caratteri alfanumerici e il carattere trattino.';
$_['text_api_status_hint'] = 'L\'ID e la chiave API utilizzati sono validi. La connessione all\'API di NewsMAN è stata testata e funziona.';
$_['text_remarketing_settings'] = 'Impostazioni remarketing';
$_['text_cron'] = 'CRON per gli iscritti alla newsletter e gli ordini';
...
$_['entry_developer_log_severity'] = 'Livello di registrazione';
$_['entry_developer_log_clean_days'] = 'Giorni pulizia registri';
$_['entry_developer_api_timeout'] = 'Timeout API';
$_['entry_developer_active_user_ip'] = 'Abilita IP di test';
...
$_['entry_send_user_ip_help'] = 'L\'indirizzo IP dell\'utente verrà inviato all\'API di NewsMAN per le richieste API di iscrizione o cancellazione.';
$_['entry_server_ip_help'] = 'L\'indirizzo IP del server verrà inviato all\'API di NewsMAN al posto dell\'indirizzo IP dell\'utente. Utilizzato quando "Invia indirizzo IP dell\'utente" è impostato su "Disabilitato".';
$_['entry_developer_active_user_ip_help'] = 'Invia sempre l\'indirizzo IP di test all\'API di NewsMAN. Questa opzione non dovrebbe essere abilitata in ambiente di produzione.';
...
$_['error_access_denied'] = 'L\'accesso è negato.';
